...
{
    /// <summary>Exam scheduling, candidate enrollment, and seat-plan management (US-055/US-056).
    /// EP-15/US-112: gated per-action via RequirePermission (Assessments module) instead of a
    ...
    public class ExamController : ControllerBase
    {
        ...
        [HttpGet("paged")]
        [RequirePermission(AccessControlModuleEnum.Assessments, PermissionActionEnum.View)]
        ...
        [HttpPost]
        [RequirePermission(AccessControlModuleEnum.Assessments, PermissionActionEnum.Create)]
        ...
        [RequirePermission(AccessControlModuleEnum.Assessments, PermissionActionEnum.Edit)]
        ...
        [RequirePermission(AccessControlModuleEnum.Assessments, PermissionActionEnum.Approve)]
