...
{
    public class ExamQuestionBulkImportValidator : AbstractValidator<ExamQuestionBulkImportCommand>
    {
        public ExamQuestionBulkImportValidator(IOptions<ExamQuestionImportSettings> importOptions)
        {
