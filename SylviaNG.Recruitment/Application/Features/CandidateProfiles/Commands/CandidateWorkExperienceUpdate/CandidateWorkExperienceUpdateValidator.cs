...
{
    public class CandidateWorkExperienceUpdateValidator : AbstractValidator<CandidateWorkExperienceUpdateCommand>
    {
        public CandidateWorkExperienceUpdateValidator()
        {
            RuleFor(x => x.CandidateWorkExperienceId)
                .GreaterThan(0).WithMessage("CandidateWorkExperienceId is required.");
