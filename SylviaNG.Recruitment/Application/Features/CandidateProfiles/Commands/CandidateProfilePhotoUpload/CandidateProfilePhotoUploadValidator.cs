...
{
    public class CandidateProfilePhotoUploadValidator : AbstractValidator<CandidateProfilePhotoUploadCommand>
    {
        public CandidateProfilePhotoUploadValidator(IOptions<CandidatePhotoSignatureSettings> options)
        {
