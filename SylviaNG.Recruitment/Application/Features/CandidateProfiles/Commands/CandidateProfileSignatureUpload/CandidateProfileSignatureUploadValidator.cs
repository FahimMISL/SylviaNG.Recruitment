...
{
    public class CandidateProfileSignatureUploadValidator : AbstractValidator<CandidateProfileSignatureUploadCommand>
    {
        public CandidateProfileSignatureUploadValidator(IOptions<CandidatePhotoSignatureSettings> options)
        {
