...
namespace SylviaNG.Recruitment.Infrastructure.Services
{
    ...
    public class ResumeParsingService : IResumeParsingService
    {
        ...
        public ResumeParsingService(IUniversityLibraryItemRepository universityLibraryItemRepository)
        {
        ...
        private static UniversityLibraryItem? MatchUniversity(string institution, List<UniversityLibraryItem> universities)
        {
