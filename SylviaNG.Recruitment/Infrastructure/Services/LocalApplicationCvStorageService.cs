...
{
    /// <summary>
    /// Local-disk implementation of <see cref="IApplicationCvStorageService"/>.
    /// Stores files under wwwroot/uploads/applications/{subFolder}/{guid}{ext} so they can be
    /// served directly by ASP.NET Core's static file middleware.
    /// </summary>
    public class LocalApplicationCvStorageService : IApplicationCvStorageService
    {
        private readonly IWebHostEnvironment _environment;
        private readonly ApplicationCvStorageSettings _settings;

        public LocalApplicationCvStorageService(IWebHostEnvironment environment, IOptions<ApplicationCvStorageSettings> options)
        {
