...
{
    /// <summary>
    /// EP-18 F3: branded office note (EP-12 US-129), rolled onto BrandedLetterPdfComposer - same
    /// "letter" shape as QuestPdfOfferLetterGenerator.
    /// </summary>
    public class QuestPdfOfficeNoteGenerator : IOfficeNotePdfGeneratorService
    {
        private readonly IWebHostEnvironment _environment;
        private readonly IBrandingResolverService _brandingResolverService;

        public QuestPdfOfficeNoteGenerator(IWebHostEnvironment environment, IBrandingResolverService brandingResolverService)
        {
        ...
        public async Task<byte[]> Generate(string documentTitle, string candidateName, string renderedBody, long sequenceValue)
        {
            ...
            var referenceNumber = ReferenceNumberComponent.BuildReferenceNumber(branding, "OFFICE-NOTE", issueDate.Year, sequenceValue);
