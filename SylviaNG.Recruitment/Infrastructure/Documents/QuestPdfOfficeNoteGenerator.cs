...
{
    /// <summary>
    /// Single-page office note (EP-12 US-129). Same QuestPDF Document.Create / Compose* shape as
    /// QuestPdfJoiningBookletGenerator - renderedBody is plain text with line breaks, each line
