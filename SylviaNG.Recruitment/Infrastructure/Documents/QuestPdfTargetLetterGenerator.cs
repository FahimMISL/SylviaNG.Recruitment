...
{
    /// <summary>
    /// Single-page target letter (EP-10 US-086). Same QuestPDF Document.Create / Compose* shape as
    /// QuestPdfAppointmentLetterGenerator - finalBody is plain text with line breaks, each line
